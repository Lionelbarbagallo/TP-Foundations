...
queries_dict = [
        {
            ...
            'archivo':'/usr/src/app/queries/mejores_clientes.csv'
            },
        {
            ...
            'archivo':'/usr/src/app/queries/ventas_zipcode.csv'  
            },
        {
            ...
            'archivo':'/usr/src/app/queries/mas_vendidos.csv'
            },
        {
            ...
            'archivo':'/usr/src/app/queries/shares.csv'
            },
        {
            ...
            'archivo':'/usr/src/app/queries/tiempo_entregas.csv'
            }
        ]
